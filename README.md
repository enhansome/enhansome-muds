...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,377 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [Blightmud](https://github.com/LiquidityC/Blightmud) ⭐ 275 | 🐛 10 | 🌐 Rust | 📅 2026-09-11 \[Linux, MacOS], \[`TLS`, `GMCP`, `MSDP`, `MCCP2`]
...
* [WinTin](http://wintin.org/) (supports Tintin++ scripting language, unmaintained in its webpage, but [Tintin++ releases](https://github.com/scandum/tintin/releases) ⭐ 260 | 🐛 13 | 🌐 C | 📅 2026-09-10 has updated windows versions)
...
* [mud-web-client](https://github.com/maldorne/mud-web-client/) ⭐ 18 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-29 (fork from MudPortal, just the web client, updated to allow wss)
...
* [mud-web-proxy](https://github.com/maldorne/mud-web-proxy/) ⭐ 15 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-10 (fork from MudPortal, just the proxy server, updated to allow wss/telnet)
...
* [Fuzzball MUCK server](https://github.com/fuzzball-muck/fuzzball) ⭐ 56 | 🐛 65 | 🌐 C | 📅 2026-09-03 source code.
...
* [ToastStunt](https://github.com/lisdude/toaststunt) ⭐ 95 | 🐛 17 | 🌐 C++ | 📅 2026-09-08, forked from stunt and being worked on.
* [LambdaMOO Programming](https://github.com/sevenecks/lambda-moo-programming) ⭐ 75 | 🐛 0 | 🌐 HTML | 📅 2026-09-04 repository, collects and updates numerous MOO guides in one place, from the original server to ToastStunt.
...
In parallel to the last versions of Mudos (the last one was v22.2b14, 2003), the Discworld developers forked it and renamed it as [FluffOS](http://fluffos.info/). [Still maintained](https://github.com/fluffos/fluffos) ⭐ 455 | 🐛 22 | 🌐 C++ | 📅 2026-09-11. It had versions 1.0 to 1.36, 2.0 to 2.27, and since 3.0 the maintainer is [Yucong Sun](https://github.com/thefallentree), and major versions has been released with the names FluffOS 2017, 2019 and 2023.

* [Official code repository](https://github.com/fluffos/fluffos) ⭐ 455 | 🐛 22 | 🌐 C++ | 📅 2026-09-11.

##### LDMud

Lars Düning continued the development of the LPMud driver renaming it to [LDMud](http://www.ldmud.eu) (but keeping the Amylaar version numbers, so starting with 3.2.2). LDMud is still [being maintained](https://github.com/ldmud/ldmud) ⭐ 158 | 🐛 47 | 🌐 C | 📅 2026-02-15.

* [Official code repository](https://github.com/ldmud/ldmud) ⭐ 158 | 🐛 47 | 🌐 C | 📅 2026-02-15.
...
Felix 'Dworkin' Croes developed in 1993 [DGD](http://www.dworkin.nl/dgd/) (Dworkin Game/Generic Driver), not derived from LPMud (so not using the same license) but compatible with LPC language. [Still maintained](https://github.com/dworkin/dgd) ⭐ 110 | 🐛 3 | 🌐 C++ | 📅 2026-08-31, and open source since v1.4 (2010).

* [Official code repository](https://github.com/dworkin/dgd) ⭐ 110 | 🐛 3 | 🌐 C++ | 📅 2026-08-31.
* [Self Conscious DGD](https://noahgibbs.github.io/self_conscious_dgd/), book about LPC for DGD written by [Noah Gibbs](https://codefol.io/).
...
| Mudlib        | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Source                                                                                                                                                                                       |
| ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.4.5         | The original mudlib distributed with Lars Pensjö's LPMud driver. Minimal by modern standards, but the direct ancestor of most other LP mudlibs \[1].                                                                                                                                                                                                                                                                                                                                                                                                                                                  | [lp-245 in the LDMud repo](https://github.com/ldmud/ldmud/tree/master/mud/lp-245) ⭐ 158 \| 🐛 47 \| 🌐 C \| 📅 2026-02-15 (lightly updated to run on modern LDMud)                           |
...
1. LDMud's `mud/lp-245` [README](https://github.com/ldmud/ldmud/tree/master/mud/lp-245) ⭐ 158 | 🐛 47 | 🌐 C | 📅 2026-02-15 describes it as "the old LP 2.4.5 mudlib, slightly updated to run with LDMud 3.2.7 or newer".
...
4. Lima mudlib project site at [limamudlib.dev](https://www.limamudlib.dev/); maintained repo at [limalib/lima](https://github.com/limalib/lima) ⭐ 10 | 🐛 17 | 🌐 C | 📅 2026-09-03; the earlier [fluffos/lima](https://github.com/fluffos/lima) ⚠️ Archived was archived read-only in October 2024. The lib's [`lib/README`](https://github.com/limalib/lima/blob/master/lib/README) ⭐ 10 | 🐛 17 | 🌐 C | 📅 2026-09-03 credits John Viega, Greg Stein and Tim Hollebeek as authors and lists Zakk Girouard among the Lima Bean admins.
...
* [DikuMUD III source code](https://github.com/Seifert69/DikuMUD3) ⭐ 226 | 🐛 38 | 🌐 C++ | 📅 2026-08-19, using HTML, websockets and Discord integration, being worked on, LGPL license.
* [DikuMUD gamma source code](https://github.com/Seifert69/DikuMUD-Gamma) ⭐ 16 | 🐛 0 | 🌐 C | 📅 2020-12-07 (the original release), [DikuMUD alpha source code](https://github.com/Seifert69/DikuMUD) ⭐ 107 | 🐛 1 | 🌐 C | 📅 2020-12-07 (newer than gamma), and [DikuMUD2 source code](https://github.com/Seifert69/DikuMUD2) ⭐ 33 | 🐛 0 | 🌐 C | 📅 2025-07-29, all with LGPL license.
...
| tbaMUD    | → CircleMUD → tbaMUD    | Community continuation of CircleMUD. Modernized with OLC, ASCII maps, and ongoing development \[2]. Active.                                                                                                                                                                                                                                                                                                                                  | [tbamud/tbamud](https://github.com/tbamud/tbamud) ⭐ 150 \| 🐛 11 \| 🌐 C \| 📅 2026-09-08                                                                                                        |
| AwakeMUD  | → CircleMUD → AwakeMUD  | Shadowrun 3rd Edition themed derivative \[3]. Active.                                                                                                                                                                                                                                                                                                                                                                                        | [luciensadi/AwakeMUD](https://github.com/luciensadi/AwakeMUD) ⭐ 77 \| 🐛 12 \| 🌐 C++ \| 📅 2026-08-23, [web](https://www.awakemud.com/)                                                         |
| EmpireMUD | → CircleMUD → EmpireMUD | Persistent world map with territory control mechanics \[4]. Active.                                                                                                                                                                                                                                                                                                                                                                          | [EmpireMUD/EmpireMUD-2.0-Beta](https://github.com/EmpireMUD/EmpireMUD-2.0-Beta) ⭐ 101 \| 🐛 13 \| 🌐 C \| 📅 2026-09-12                                                                          |
...
1. [tbamud/tbamud](https://github.com/tbamud/tbamud) ⭐ 150 | 🐛 11 | 🌐 C | 📅 2026-09-08 repo README.
2. [EmpireMUD/EmpireMUD-2.0-Beta](https://github.com/EmpireMUD/EmpireMUD-2.0-Beta) ⭐ 101 | 🐛 13 | 🌐 C | 📅 2026-09-12 repo README.
3. [luciensadi/AwakeMUD](https://github.com/luciensadi/AwakeMUD) ⭐ 77 | 🐛 12 | 🌐 C++ | 📅 2026-08-23 repo README.
...
* [Web](https://www.evennia.com/), [Github project](https://github.com/evennia/evennia) ⭐ 2,098 | 🐛 129 | 🌐 Python | 📅 2026-09-09, [discussion forum](https://github.com/evennia/evennia/discussions) ⭐ 2,098 | 🐛 129 | 🌐 Python | 📅 2026-09-09, [Discord server](https://discord.com/invite/AJJpcRUhtF).
...
* [Web](http://www.coffeemud.org/), [Github project](https://github.com/bozimmerman/CoffeeMud) ⭐ 233 | 🐛 3 | 🌐 Java | 📅 2026-09-06.
...
* [Web](https://lofp.metavert.io), [Github project](https://github.com/jonradoff/lofp) ⭐ 180 | 🐛 47 | 🌐 HTML | 📅 2026-05-17, [Wikipedia](https://en.wikipedia.org/wiki/Legends_of_Future_Past).
...
* **MudOS / FluffOS Copyright** (1991) — MudOS inherited Lars Pensjö's LPMud non-commercial copyright and layered its own notices on top (1991–1992 contributors; the entire package copyright 1995 by Tim Hollebeek). [FluffOS](#fluffos), forked from MudOS, carries the same chain unchanged: its [`Copyright` file](https://github.com/fluffos/fluffos/blob/master/Copyright) ⭐ 455 | 🐛 22 | 🌐 C++ | 📅 2026-09-11 restates that the source "may not be used in any way whatsoever for monetary gain" and that the LPMud and MudOS copyright restrictions still apply. Despite FluffOS being actively maintained, this remains a custom non-commercial license, not a recognized open source one.
