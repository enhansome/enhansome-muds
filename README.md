...
* [Blightmud](https://github.com/LiquidityC/Blightmud) ⭐ 274 | 🐛 10 | 🌐 Rust | 📅 2026-09-02 \[Linux, MacOS], \[`TLS`, `GMCP`, `MSDP`, `MCCP2`]
...
* [WinTin](http://wintin.org/) (supports Tintin++ scripting language, unmaintained in its webpage, but [Tintin++ releases](https://github.com/scandum/tintin/releases) ⭐ 258 | 🐛 11 | 🌐 C | 📅 2026-09-01 has updated windows versions)
...
* [ToastStunt](https://github.com/lisdude/toaststunt) ⭐ 95 | 🐛 18 | 🌐 C++ | 📅 2026-08-21, forked from stunt and being worked on.
...
In parallel to the last versions of Mudos (the last one was v22.2b14, 2003), the Discworld developers forked it and renamed it as [FluffOS](http://fluffos.info/). [Still maintained](https://github.com/fluffos/fluffos) ⭐ 453 | 🐛 21 | 🌐 C++ | 📅 2026-09-05. It had versions 1.0 to 1.36, 2.0 to 2.27, and since 3.0 the maintainer is [Yucong Sun](https://github.com/thefallentree), and major versions has been released with the names FluffOS 2017, 2019 and 2023.

* [Official code repository](https://github.com/fluffos/fluffos) ⭐ 453 | 🐛 21 | 🌐 C++ | 📅 2026-09-05.

##### LDMud

Lars Düning continued the development of the LPMud driver renaming it to [LDMud](http://www.ldmud.eu) (but keeping the Amylaar version numbers, so starting with 3.2.2). LDMud is still [being maintained](https://github.com/ldmud/ldmud) ⭐ 157 | 🐛 46 | 🌐 C | 📅 2026-02-15.

* [Official code repository](https://github.com/ldmud/ldmud) ⭐ 157 | 🐛 46 | 🌐 C | 📅 2026-02-15.
...
| Mudlib        | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Source                                                                                                                                                                                       |
| ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.4.5         | The original mudlib distributed with Lars Pensjö's LPMud driver. Minimal by modern standards, but the direct ancestor of most other LP mudlibs \[1].                                                                                                                                                                                                                                                                                                                                                                                                                                                  | [lp-245 in the LDMud repo](https://github.com/ldmud/ldmud/tree/master/mud/lp-245) ⭐ 157 \| 🐛 46 \| 🌐 C \| 📅 2026-02-15 (lightly updated to run on modern LDMud)                           |
...
1. LDMud's `mud/lp-245` [README](https://github.com/ldmud/ldmud/tree/master/mud/lp-245) ⭐ 157 | 🐛 46 | 🌐 C | 📅 2026-02-15 describes it as "the old LP 2.4.5 mudlib, slightly updated to run with LDMud 3.2.7 or newer".
...
| tbaMUD    | → CircleMUD → tbaMUD    | Community continuation of CircleMUD. Modernized with OLC, ASCII maps, and ongoing development \[2]. Active.                                                                                                                                                                                                                                                                                                                                  | [tbamud/tbamud](https://github.com/tbamud/tbamud) ⭐ 150 \| 🐛 33 \| 🌐 C \| 📅 2026-09-05                                                                                                        |
...
| EmpireMUD | → CircleMUD → EmpireMUD | Persistent world map with territory control mechanics \[4]. Active.                                                                                                                                                                                                                                                                                                                                                                          | [EmpireMUD/EmpireMUD-2.0-Beta](https://github.com/EmpireMUD/EmpireMUD-2.0-Beta) ⭐ 101 \| 🐛 12 \| 🌐 C \| 📅 2026-09-04                                                                          |
...
1. [tbamud/tbamud](https://github.com/tbamud/tbamud) ⭐ 150 | 🐛 33 | 🌐 C | 📅 2026-09-05 repo README.
2. [EmpireMUD/EmpireMUD-2.0-Beta](https://github.com/EmpireMUD/EmpireMUD-2.0-Beta) ⭐ 101 | 🐛 12 | 🌐 C | 📅 2026-09-04 repo README.
...
* [Web](https://www.evennia.com/), [Github project](https://github.com/evennia/evennia) ⭐ 2,094 | 🐛 127 | 🌐 Python | 📅 2026-09-02, [discussion forum](https://github.com/evennia/evennia/discussions) ⭐ 2,094 | 🐛 127 | 🌐 Python | 📅 2026-09-02, [Discord server](https://discord.com/invite/AJJpcRUhtF).
...
* [Web](http://www.coffeemud.org/), [Github project](https://github.com/bozimmerman/CoffeeMud) ⭐ 233 | 🐛 2 | 🌐 Java | 📅 2026-09-05.
...
* [Web](https://lofp.metavert.io), [Github project](https://github.com/jonradoff/lofp) ⭐ 180 | 🐛 42 | 🌐 HTML | 📅 2026-05-17, [Wikipedia](https://en.wikipedia.org/wiki/Legends_of_Future_Past).
...
* **MudOS / FluffOS Copyright** (1991) — MudOS inherited Lars Pensjö's LPMud non-commercial copyright and layered its own notices on top (1991–1992 contributors; the entire package copyright 1995 by Tim Hollebeek). [FluffOS](#fluffos), forked from MudOS, carries the same chain unchanged: its [`Copyright` file](https://github.com/fluffos/fluffos/blob/master/Copyright) ⭐ 453 | 🐛 21 | 🌐 C++ | 📅 2026-09-05 restates that the source "may not be used in any way whatsoever for monetary gain" and that the LPMud and MudOS copyright restrictions still apply. Despite FluffOS being actively maintained, this remains a custom non-commercial license, not a recognized open source one.
