...
In parallel to the last versions of Mudos (the last one was v22.2b14, 2003), the Discworld developers forked it and renamed it as [FluffOS](http://fluffos.info/). [Still maintained](https://github.com/fluffos/fluffos) ⭐ 453 | 🐛 25 | 🌐 C++ | 📅 2026-09-02. It had versions 1.0 to 1.36, 2.0 to 2.27, and since 3.0 the maintainer is [Yucong Sun](https://github.com/thefallentree), and major versions has been released with the names FluffOS 2017, 2019 and 2023.

* [Official code repository](https://github.com/fluffos/fluffos) ⭐ 453 | 🐛 25 | 🌐 C++ | 📅 2026-09-02.
...
| tbaMUD    | → CircleMUD → tbaMUD    | Community continuation of CircleMUD. Modernized with OLC, ASCII maps, and ongoing development \[2]. Active.                                                                                                                                                                                                                                                                                                                                  | [tbamud/tbamud](https://github.com/tbamud/tbamud) ⭐ 150 \| 🐛 17 \| 🌐 C \| 📅 2026-09-02                                                                                                        |
...
1. [tbamud/tbamud](https://github.com/tbamud/tbamud) ⭐ 150 | 🐛 17 | 🌐 C | 📅 2026-09-02 repo README.
...
* [Web](https://www.evennia.com/), [Github project](https://github.com/evennia/evennia) ⭐ 2,092 | 🐛 126 | 🌐 Python | 📅 2026-09-02, [discussion forum](https://github.com/evennia/evennia/discussions) ⭐ 2,092 | 🐛 126 | 🌐 Python | 📅 2026-09-02, [Discord server](https://discord.com/invite/AJJpcRUhtF).
...
* [Web](https://lofp.metavert.io), [Github project](https://github.com/jonradoff/lofp) ⭐ 180 | 🐛 39 | 🌐 HTML | 📅 2026-05-17, [Wikipedia](https://en.wikipedia.org/wiki/Legends_of_Future_Past).
...
* **MudOS / FluffOS Copyright** (1991) — MudOS inherited Lars Pensjö's LPMud non-commercial copyright and layered its own notices on top (1991–1992 contributors; the entire package copyright 1995 by Tim Hollebeek). [FluffOS](#fluffos), forked from MudOS, carries the same chain unchanged: its [`Copyright` file](https://github.com/fluffos/fluffos/blob/master/Copyright) ⭐ 453 | 🐛 25 | 🌐 C++ | 📅 2026-09-02 restates that the source "may not be used in any way whatsoever for monetary gain" and that the LPMud and MudOS copyright restrictions still apply. Despite FluffOS being actively maintained, this remains a custom non-commercial license, not a recognized open source one.
