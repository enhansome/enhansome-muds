...
* [Blightmud](https://github.com/LiquidityC/Blightmud) ⭐ 276 | 🐛 10 | 🌐 Rust | 📅 2026-09-14 \[Linux, MacOS], \[`TLS`, `GMCP`, `MSDP`, `MCCP2`]
...
| AwakeMUD  | → CircleMUD → AwakeMUD  | Shadowrun 3rd Edition themed derivative \[3]. Active.                                                                                                                                                                                                                                                                                                                                                                                        | [luciensadi/AwakeMUD](https://github.com/luciensadi/AwakeMUD) ⭐ 78 \| 🐛 12 \| 🌐 C++ \| 📅 2026-08-23, [web](https://www.awakemud.com/)                                                         |
| EmpireMUD | → CircleMUD → EmpireMUD | Persistent world map with territory control mechanics \[4]. Active.                                                                                                                                                                                                                                                                                                                                                                          | [EmpireMUD/EmpireMUD-2.0-Beta](https://github.com/EmpireMUD/EmpireMUD-2.0-Beta) ⭐ 101 \| 🐛 13 \| 🌐 C \| 📅 2026-09-16                                                                          |
...
2. [EmpireMUD/EmpireMUD-2.0-Beta](https://github.com/EmpireMUD/EmpireMUD-2.0-Beta) ⭐ 101 | 🐛 13 | 🌐 C | 📅 2026-09-16 repo README.
3. [luciensadi/AwakeMUD](https://github.com/luciensadi/AwakeMUD) ⭐ 78 | 🐛 12 | 🌐 C++ | 📅 2026-08-23 repo README.
...
* [Web](https://lofp.metavert.io), [Github project](https://github.com/jonradoff/lofp) ⭐ 180 | 🐛 50 | 🌐 HTML | 📅 2026-05-17, [Wikipedia](https://en.wikipedia.org/wiki/Legends_of_Future_Past).
